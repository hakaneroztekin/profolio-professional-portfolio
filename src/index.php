                        ...
                        <li class="li-details">
                            ...
                            <span class="details">
                                ...
                                <p class="details-content w3-container">
                                    ...
                                    <b>Technology stack:</b> Java 8, Spring MVC, Hibernate, SQL, Maven, Java Server Pages (JSP), Java Server Faces (JSF), Primefaces, JSON, HTML / XHTML, CSS, Ajax, IntelliJ, SVN
                                </p></span>
                        </li>
                    </ul>
                    <ul>
