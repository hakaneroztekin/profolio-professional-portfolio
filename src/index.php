...
<body>
    <header>
        <div class="wrapper">
            ...
            <nav>
                ...
                <ul>
                    <li><a href="#top">HOME</a></li>                       <li><a href="#about">ABOUT</a></li>
                    <li><a href="#experience">EXPERIENCE</a></li>             <li><a href="#projects">PROJECTS</a></li>
                </ul>
            </nav>
        ...
        <section id="education-experience">
            <div class="w3-container">
                ...
                <div id="education-experience-background" class="w3-hide-small w3-hide-medium w3-mobile">
                    <img src="wp-content/themes/portfolio/images/service-bg.png">
                ...
                <ul>
                    ...
                    <li class="li-details">
                        <span class="titles">
                            <p class="title">Java Developer Intern</p>
                        ...
                        <span class="details">
                            ...
                            <p class="details-content w3-container">
                                adesso Turkey is a fast growing company which has raised a need for easier approach to identify the best candidates. As a member of the <b>agile global team</b>, I have developed a <b>Java based Web application</b> to meet the needs. It can <b>create tests</b>, <b>send them to candidates</b> and <b>monitor their performance</b>. My responsibility has also included <b>helping newly started interns</b> to get familiar with the project and <b>working together with the front-end developers</b> for the project integration. Lastly, I prepared the <b>documentation</b>. The internship was an <b>extraordinary experience</b> for me that contributed me to <b>shape my future</b> as a <b>Java Developer</b>.
                                <br>
                                <b>Technology stack:</b> Java 8, Spring Boot, Spring MVC, Spring Security, Spring Batch, Hibernate, SQL, HeidiSQL, RESTful Web Services, Maven, Lombok, Quartz, JSON, IntelliJ, Swagger UI, Postman, Sourcetree, Git / Github
                            </p></span>
                    </li>
                </ul>
                <ul>
                ...
                <ul>
                    ...
                    <li class="li-details">
                        <span class="titles">
                            ...
                            <p class="alt-title w3-hide-small">Sınavı Yerim, July 2013 - Present</p>
                            <p class="alt-title w3-hide-medium w3-hide-large">Sınavı Yerim,<br>July 2013 - Present</p>
                        </span>
                        <span class="show-details-button" tabindex="0">Show Details</span>
    ...
    <footer>
        <div class="w3-container wrapper w3-hide-medium w3-hide-large">
        ...
        <div class="w3-container wrapper w3-hide-small">
            <span class="w3-container w3-quarter"  style="text-align: left;">
                <div span="w3-row">
                    <div span="w3-col">
                        <a href="https://www.facebook.com/hakan.eroztekin.3">
